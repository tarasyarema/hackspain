...
def build_xml(profile: Profile, L: Layout = Layout(), seed: int = 0) -> str:
  ...
  <worldbody>
    ...
    <geom name="splitter" type="box" size="0.14 {L.belt_w / 2 + 0.02:.4f} 0.006" pos="{splitter_x:.12f} 0 {splitter_z:.12f}" euler="0 {splitter_angle} 0" material="steel" class="static"/>
    ...
    <geom name="bin_reject" type="box" size="0.26 {L.belt_w / 2 + 0.02:.4f} 0.030" pos="{L.split_x + 0.20:.3f} 0 {bz - 0.447:.3f}" rgba="0.75 0.2 0.15 1" class="static"/>
    <geom name="bin_accept_end" type="box" size="0.003 {L.belt_w / 2 + 0.02:.4f} 0.06" pos="{L.split_x + 0.42:.3f} 0 {L.split_z + 0.015:.3f}" rgba="0.2 0.6 0.25 0.5" class="static"/>
    <geom name="bin_reject_end" type="box" size="0.003 {L.belt_w / 2 + 0.02:.4f} 0.06" pos="{L.split_x + 0.46:.3f} 0 {bz - 0.36:.3f}" rgba="0.75 0.2 0.15 0.5" class="static"/>

...
def build_xml(profile: Profile, L: Layout = Layout(), seed: int = 0) -> str:
  ...
  <worldbody>
    ...
    <geom name="bin_accept_end" type="box" size="0.015 {L.belt_w / 2 + 0.02:.4f} 0.06" pos="{L.split_x + 0.432:.3f} 0 {bz - 0.24:.3f}" rgba="0.2 0.6 0.25 0.5" class="static"/>
    <geom name="bin_reject_end" type="box" size="0.015 {L.belt_w / 2 + 0.02:.4f} 0.06" pos="{L.split_x + 0.192:.3f} 0 {bz - 0.36:.3f}" rgba="0.75 0.2 0.15 0.5" class="static"/>
